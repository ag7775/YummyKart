...
public class BiryaniRiceFragment extends Fragment
{
    ...
    public BiryaniRiceFragment(FloatingActionButton fab)
    {
        this.fab = fab;
    }

    public BiryaniRiceFragment()
    {
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        for(i=0;i<n;i++)
        {
            ...
            if(menuInitialisation.getCategory().toLowerCase().indexOf("BIRYANI & RICE".toLowerCase()) != -1)
            {
    ...
    {
        View rootView = inflater.inflate(R.layout.fragment_rice_biryani,container,false);
