...
import static hu.pe.yummykart.yummykart.R.color.red;

public class DataAdapterForCurrentOrders extends RecyclerView.Adapter<DataAdapterForCurrentOrders.CurrentOrdersViewHolder>
{
    Context context;
    public ArrayList<CurrentOrdersDataModel> currentOrdersDataModelArrayList;

    public DataAdapterForCurrentOrders(Context c, ArrayList<CurrentOrdersDataModel> currentOrdersDataModelArrayList) {
        this.context = c;
        this.currentOrdersDataModelArrayList = currentOrdersDataModelArrayList;
    }

    @Override
    public DataAdapterForCurrentOrders.CurrentOrdersViewHolder onCreateViewHolder(ViewGroup parent, int viewType)
    {
    ...
    @Override
    public void onBindViewHolder(final DataAdapterForCurrentOrders.CurrentOrdersViewHolder holder, final int position) {
        ...
        holder.tv_status.setTextColor(Color.parseColor("#70cc20"));
