package hu.pe.yummykart.yummykart.activity;
        ...
        import hu.pe.yummykart.yummykart.app.Config;
        import hu.pe.yummykart.yummykart.app.MyApplication;
        import hu.pe.yummykart.yummykart.helper.PrefManager;
        import hu.pe.yummykart.yummykart.service.HttpService;
...
public class SmsActivity extends AppCompatActivity implements View.OnClickListener
{
    ...
    private EditText inputPin, inputMobile, inputOtp;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        inputMobile.setCompoundDrawablesWithIntrinsicBounds(R.mipmap.ic_perm_identity_black_24dp, 0, 0, 0);
        inputPin.setCompoundDrawablesWithIntrinsicBounds(R.mipmap.ic_local_post_office_black_24dp, 0, 0, 0);
    ...
    private void requestForSMS(final String pin, final String mobile) {
