...
public class CurryFragment extends Fragment
{
    ...
    public CurryFragment(FloatingActionButton fab)
    {
       this.fab = fab;
    }
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        for(i=0;i<n;i++)
        {
            ...
            if(menuInitialisation.getCategory().toLowerCase().indexOf("CURRY".toLowerCase()) != -1)
            {
    ...
    {
        View rootView = inflater.inflate(R.layout.fragment_curry,container,false);
