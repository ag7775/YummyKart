...
public class DryFragment extends Fragment
{
    ...
    public DryFragment(FloatingActionButton fab)
    {
        this.fab = fab;
    }
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        for(i=0;i<n;i++)
        {
            ...
            if(menuInitialisation.getCategory().toLowerCase().indexOf("DRY".toLowerCase()) != -1)
            {
    ...
    {
        View rootView = inflater.inflate(R.layout.fragment_dry,container,false);
